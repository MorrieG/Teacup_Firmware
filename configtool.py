...
if sys.version_info.major >= 3:
    print("You are currently running Python3. Python3 is not supported, \n"
          "because there is no wxPython for Python3. Please try running \n"
          "with Python2. It often works to type \"python2 configtool.py\n"
          "in the command line.")
    time.sleep(2)  # change from 10 to 2 while upgrading
    # sys.exit(-1) # comment out while upgrading
...
def CommandLine(argv):
    """ Parse and act on command line arguments.  All script automation
    commands result in sys.exit() (i.e. they do not return from this
    function).  Other options like --debug will return to allow the gui
     to launch.
    """
